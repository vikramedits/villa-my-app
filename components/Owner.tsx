  ...
  return (
    <section ref={sectionRef} className=" py-8 md:py-12">
      <div className="container-fluid">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 justify-center">
          {OWNERS.map((owner, idx) => (
            ...
            `}
              ...
              <div className="shrink-0 mx-auto md:mx-0 flex gap-10 md:gap-20 items-center">
              ...
              <div className="mt-4 md:mt-8 text-center md:text-left flex-1 relative">
