...
export default function CheckBooking() {
  ...
  return (
    <section className="container-fluid">
      <div className=" my-5 md:my-10 py-5 mx-auto bg-gray-100  rounded-2xl shadow-2xl ">
        ...
        {!bookingDetails && !ref && !phone && (
          <div className=" mx-auto md:w-1/2  text-center bg-gray-100 rounded-lg my-4 md:my-8 py-3 md:py-2">
            <div className="flex flex-col mx-3 mb-3 items-center justify-center gap-2 p-4 bg-red-50 rounded-lg border border-red-200 shadow-xl">
              <svg
        ...
        <div className="bg-black px-2 md:px-4 py-4 md:py-6 mb-5 md:mb-8 rounded-lg w-full md:w-1/2 mx-auto shadow-xl">
          <div className="flex items-center gap-2 text-yellow-100 pb-6">
            <Info className="w-4 h-4 mt-0.5 text-yellow-200" />
            <p className="text-xs md:text-base tracking-wider leading-relaxed">
          ...
          <div className="space-y-4 max-w-md mx-auto">
            ...
            <button
              onClick={handleCheck}
              disabled={loading}
              className={`w-full bg-blue-600 hover:bg-blue-700 text-white py-3 cursor-pointer rounded-sm font-semibold ${loading ? "opacity-50 cursor-not-allowed" : ""}`}
            >
          ...
          <div className="mt-4 md:mt-0 border-l-4 border-blue-500 pl-4 text-sm space-y-3">
            ...
            <Link
              href="/gallery"
              className="mt-4 w-full md:w-auto bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 my-2 rounded-sm font-semibold"
            >
              Explore Property
            </Link>
